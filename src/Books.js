...
class BestBooks extends React.Component {
    ...
    handelAddModal = (e) => {
        ...
        axios
            .post(`${process.env.REACT_APP_API_URL}/booksCollection`, reqBody)
    ...
    handelUpdateModal = (e) => {
        ...
        axios.put(`${process.env.REACT_APP_API_URL}/booksCollection/${this.state.selectedBookDataObj._id}`, reqBody).then(updatedBookObject => {
    ...
    handelDeleteBook = (bookId) => {
        console.log("1");
        console.log(`${process.env.REACT_APP_API_URL}/booksCollection/${bookId}`);

        axios
            .delete(`${process.env.REACT_APP_API_URL}/booksCollection/${bookId}`)
            .then((deleteResponse) => {
                console.log("2");
                console.log(`${process.env.REACT_APP_API_URL}/booksCollection`);
    ...
    componentDidMount = () => {
        axios
            .get(`${process.env.REACT_APP_API_URL}/booksCollection`)
            .then((bookResponse) => {
